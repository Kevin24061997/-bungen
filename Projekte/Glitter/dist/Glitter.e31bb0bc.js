 ...
 *
 */
var Glitt = /*#__PURE__*/_createClass(function Glitt(data) {
  _classCallCheck(this, Glitt);
...
function saveGlitt() {
  ...
  var glittText = document.getElementById("inputt_text").value;
  var glittName = document.getElementById("inputt_name").value;
...
function getGlittsFromBackend() {
  fetch("http://localhost:4000/glitts").then(function (res) {
    return res.json();
  }).then(function (json) {
    var glitts = json.map(function (glitt) {
      return new Glitt(glitt);
    });
...
function postGlittToBackend(glittName, glittText) {
  ...
  fetch("http://localhost:1234/glitts", fetchConfig).then(function (res) {
...
//# sourceMappingURL=/Glitter.e31bb0bc.js.map